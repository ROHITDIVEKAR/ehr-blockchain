...
const registerUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userExists)
        throw user_responses_1.USER_RESPONSES.ALREADY_EXISTS;
    yield encryptPassword(data.password);
    data.role = constant_1.Role.USER;
    const user = user_service_1.default.create(data);
    return user;
});
const login = (credential) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_service_1.default.findOne(credential);
    if (!user)
